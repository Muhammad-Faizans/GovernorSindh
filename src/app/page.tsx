...
export default function HomePage() {
  return (
    <>
      <main>
        <section
          className="relative min-h-[140vh] sm:min-h-[160vh] md:min-h-[180vh] lg:min-h-screen text-left text-white pt-[70px] pb-20 sm:pb-32 sm:mb-20"
          id="hero"
        >
          <Image
      ...
      <div className="container mt-24 mx-auto px-12 py-4">
        <h1 className="text-center xl:text-[36px] sm:text-[32px] text-xl sm:leading-[2.5rem] leading-[1.75rem] text-main font-extrabold m-auto md:w-[95%] text-blue-900">
        ...
        <hr />
        <h1 className="text-left mt-6 mb-7 xl:text-[36px] sm:text-[32px] text-xl sm:leading-[2.5rem] leading-[1.75rem] text-main font-extrabold m-auto md:w-[95%] text-blue-900">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center  transition duration-300 ease-in-out hover:scale-110 cursor-pointer ">
            ...
            />
            <span className="bg-white border-2 rounded-md p-6 block font-bold text-slate-800 lg:text-3xl">
